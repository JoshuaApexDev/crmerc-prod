                    ...
                    <tr>
                        <td class="header"
                           ...
                           style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #bbbfc3; font-size: 19px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 #ffffff; display: inline-block;">
                            <img src="http://crmerc.apexcallcenter.com/tax-logo-s-fondo.png" class="logo"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Please find the link to the document repository below. You can upload the required documents there. </p>
                                        <h2 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 16px; font-weight: bold; margin-top: 0; text-align: left;">
                                            Link:
                                            <a href={{$link}}>
                                                Click to upload the required files
                                            </a>
                                        </h2>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #aeaeae; font-size: 12px; text-align: center;">
                                            © 2023 ApexDevelopment. All rights reserved.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
